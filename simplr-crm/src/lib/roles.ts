...
export const ROLES: RoleDef[] = [
  { key: 'owner', label: 'Owner / Admin', short: 'here’s the whole business at a glance', blurb: 'Full view — pipeline, revenue, operations & team', accent: '#13927B' },
  ...
  { key: 'sales', label: 'Sales Manager', short: 'here’s your pipeline', blurb: 'Deals, leads, quota & activities', accent: '#1FAE94' },
  { key: 'marketing', label: 'Marketing', short: 'here’s what’s driving leads', blurb: 'Campaigns, lead sources & outreach', accent: '#159C86' },
