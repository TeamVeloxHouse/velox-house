        ...
        <div className="rounded-card p-5 text-white relative overflow-hidden" style={{ background: 'linear-gradient(150deg,#15223B,#0A3B33)' }}>
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-[13px] mt-0.5" style={{ color: '#c3ccdb' }}>Upload your current price list or a recent quote — Ovi extracts your cost/kWp, adders and margins into the calculator below for you to review.</div>
            </div>
        ...
        <div className="grid gap-4" style={{ gridTemplateColumns: '1.4fr 1fr' }}>
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-surface border border-border rounded-card p-5">
              ...
              <div className="text-[11px] text-muted-3 mt-2.5 leading-snug">Finance is provided under your own lender agreements — Solar House just shows the payments. UK: displaying consumer finance may require FCA authorisation; take advice before going live.</div>
            </div>
          </div>
