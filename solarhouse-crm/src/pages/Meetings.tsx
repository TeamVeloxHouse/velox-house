      ...
      {mode === 'Calendar' ? <CalendarView only={['meeting']} /> : <div className="flex-1 flex min-h-0">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <div className="px-7 py-4 border-b border-border bg-[#FBFCFF] flex items-center gap-3">
            ...
            <div className="flex-1"><div className="text-[13.5px] font-semibold text-ink-2">Solar House Notetaker</div><div className="text-[12px] text-muted-2">Joins the call, transcribes live, and writes notes + action items to {active.dealOrg}’s card.</div></div>
  ...
  return (
    <Modal open={open} onClose={onClose} title="Schedule meeting" subtitle="The AI notetaker can join automatically"
      ...
      <label className="flex items-center gap-2.5 mt-1 cursor-pointer">
        ...
        <span className="text-[13px] text-ink-2">Solar House Notetaker joins &amp; summarises</span>
      </label>
    </Modal>
  )
}
