...
export function MarketingOverview() {
  ...
  return (
    <DeptPage title="Solar House Marketing" crumb="Brand & content operations"
...
export function BrandHub() {
  ...
  return (
    <DeptPage title="Solar House Marketing" crumb="Brand Hub"
...
export function MarketingAssets() {
  ...
  return (
    <DeptPage title="Solar House Marketing" crumb="Assets" kpis={<>
...
export function ContentPlanner() {
  ...
  return (
    <DeptPage title="Solar House Marketing" crumb="Content" kpis={<>
...
export function MarketingSocial() {
  ...
  return (
    <DeptPage title="Solar House Marketing" crumb="Social" kpis={<>
...
export function MarketingRequests() {
  ...
  return (
    <DeptPage title="Solar House Marketing" crumb="Requests" kpis={<>
...
export function MarketingConnectors() {
  ...
  return (
    <DeptPage title="Solar House Marketing" crumb="Connectors" kpis={<>
      ...
      <AiStrip role="Connections" blurb="Solar House is the library and the operator — not the design tool. Connect Canva, Figma or Claude Design and their finished work lands back here, tagged and versioned. Design goes out; the asset comes back."
        actions={[
