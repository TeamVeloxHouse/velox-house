    ...
    <div className="rounded-card border border-[#D8D0FF] bg-gradient-to-br from-[#F6F3FF] to-white overflow-hidden">
      <div className="px-5 py-3.5 flex items-center gap-2.5 border-b border-[#EAE4FF]">
        ...
        <div className="flex-1">
          <div className="text-[14px] font-bold text-ink flex items-center gap-2">Ovi · Outreach operator <Chip tone="positive" dot>Live</Chip></div>
    ...
    <>
      ...
      <PageBody>
        <div className="rounded-card bg-gradient-to-br from-[#F6F3FF] to-white border border-[#E0D8FF] p-4 flex items-start gap-3">
          ...
          <div><div className="text-[13px] font-semibold text-ink-2">Set-and-forget outreach</div><div className="text-[12.5px] text-muted-b mt-0.5">Schedule any AI operator command to run on a cadence — Solar House prospects, writes and sends, then reports the result back to you each time.</div></div>
        </div>
