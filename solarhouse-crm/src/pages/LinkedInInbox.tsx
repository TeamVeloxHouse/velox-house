      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="w-[380px] shrink-0 bg-surface border-r border-border overflow-y-auto">
          <div className="px-4 py-3 border-b border-border flex items-center gap-2.5">
            ...
            <div className="flex-1 min-w-0"><div className="text-[13px] font-semibold text-ink-2">Solar House · via Unipile</div><div className="text-[12px] text-muted-2">Connected · {unread} unread</div></div>
