      ...
      <PageBody>
        ...
        <div className="rounded-card border border-border-blue bg-[#FBFCFF] overflow-hidden">
          <div className="px-4 py-3 border-b border-border-blue flex items-center gap-2.5">
            ...
            <div className="flex-1">
              <div className="text-[13.5px] font-bold text-ink">Design with Ovi</div>
        ...
        {!analysing && !design && (
          <div className="bg-surface border border-border rounded-card p-10 text-center">
            ...
            <div className="text-[13px] text-muted-b mt-1 max-w-[440px] mx-auto">Type a property address and Solar House generates a panel layout, production estimate, savings and a live price — ready to turn into a proposal.</div>
