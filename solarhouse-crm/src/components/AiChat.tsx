    ...
    <div className={classNames('bg-surface border border-border rounded-2xl flex flex-col gap-1 p-2 shadow-card')}>
      ...
      <div className="flex items-end gap-2">
        ...
        <textarea
          ...
          rows={1}
          placeholder={placeholder ?? 'Ask Ovi to analyse, draft, or do something…'}
  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div className="flex-1">
        <div className="text-[14px] font-bold text-ink flex items-center gap-2">Ovi <Chip tone="positive" dot>Autonomous</Chip></div>
      </div>
      {right}
    </div>
  )
